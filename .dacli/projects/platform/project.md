...
# Platform and shell
## Goal
Audit and upgrade everything outside the feature slices: src/services (15 services incl. the whole storage stack), src/stores (7 root stores), src/components (app shell, menubars, ThreePanelLayout, CommandPalette), src/composables, src/lib, src/router, src/ui, plus build config, CI, and dependency health. Owns the storage and navigation halves of the stranded migration.
## Constraints
