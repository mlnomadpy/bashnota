...
# AI slice
## Goal
Audit and upgrade src/features/ai (9 .vue, 27 .ts, 9253 LOC). Owns the multi-provider AI abstraction (providerFactory, providers/), conversations, the assistant sidebar (989 LOC), AI code actions, and in-browser inference via @mlc-ai/web-llm. Three stores: aiActionsStore, aiConversationStore, aiSettingsStore. Key question: API key handling and the bundle cost of web-llm.
## Constraints
