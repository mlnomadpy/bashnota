...
# Auth slice
## Goal
Audit and upgrade src/features/auth (4 .vue, 3 .ts, 1682 LOC) together with firestore.rules, storage.rules and functions/. Owns Firebase auth, user tags, profiles, and the router guard. Small in LOC, large in blast radius.
## Constraints
