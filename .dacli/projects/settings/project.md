...
# Settings slice
## Goal
Audit and upgrade src/features/settings (47 .vue, 8 .ts, 13049 LOC). 47 components for settings alone is the highest component-to-logic ratio in the app. Owns the settings UI tree and is one of the three stranded migrations (USE_CONSOLIDATED_SETTINGS, consolidatedSettingsService + settingsAdapter vs the legacy settingsStore).
## Constraints
