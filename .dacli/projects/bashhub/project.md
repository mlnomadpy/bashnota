...
# BashHub slice
## Goal
Audit and upgrade src/features/bashhub (5 .vue, 5 .ts, 3751 LOC). Owns the home view (including the new filesystem-notas home added in PR #369), public user profiles at /@:userTag and /u/:userId, and statisticsService. UserPublishedView.vue is 1306 LOC.
## Constraints
