...
# Editor slice
## Goal
Audit and upgrade src/features/editor (114 .vue, 82 .ts, 53231 LOC — 44% of the app). Owns the TipTap editor shell, 14 custom block types (citation, confusion-matrix, executable-code, math, nota-config, nota-title, pipeline, sub-nota, subfigure, table, theorem, youtube), the markdown parser and paste handler, export services, and the code-execution store. Largest file in the project lives here: pipeline/PipelineNode.vue at 2116 LOC.
## Constraints
