...
# Jupyter slice
## Goal
Audit and upgrade src/features/jupyter (7 .vue, 5 .ts, 2375 LOC) plus src/services/codeExecutionService.ts. Owns kernel discovery, session management, WebSocket execution over ws, and NotaConfig kernel binding. This is the highest-trust surface in the app: it runs code.
## Constraints
