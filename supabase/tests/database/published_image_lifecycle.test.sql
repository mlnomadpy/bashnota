...
select is((select count(*) from public.published_image_assets),3::bigint,
  'database publication deletion never removes storage asset metadata directly');
select is((select count(*) from public.published_image_assets where owner_id='61000000-0000-0000-0000-000000000001'),2::bigint,
